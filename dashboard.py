...
bars = media_por_turma.plot(kind='bar', color=colors, ax=ax)
...
dados_turma.set_index('Nome')[componentes].plot(
    kind='bar', stacked=True, ax=ax, colormap='Set3')
...
fig, ax = plt.subplots()
sns.histplot(notas_filtradas, bins=10, kde=True, color='orange', ax=ax)
